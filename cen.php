...
ulang:
// function change(){
echo color("red","                    SIUBIE QU\n");
echo color("blue","           Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("white","                    kowe sing tak sayang        \n");
echo color("white","                  Nulise ongko 62*** \n");
        $nama = nama();
        ...
        echo color("white","WESS CROOTT\n");
        $token = getStr('"access_token":"','"',$verif);
        $uuid = getStr('"resource_owner_id":',',',$verif);
        echo color("white","+] Your access token : ".$token."\n\n");
        save("token.txt",$token); 
        echo color("white","\n▬▬▬▬▬▬▬▬▬▬▬▬KOCOK SEK DADUNE▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("white","CLAIM PERAWAN..");
